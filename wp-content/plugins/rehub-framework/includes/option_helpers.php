...
$custom_badge_admin = array(
	...
	'description' => esc_html__('Check this if you want to show badge. You can customize them in theme option', 'rehub-framework'),
	'items' => array(
	    array(
	        'value' => '0',
...
function rehub_get_post_layout_array()
{
	$postlayout = apply_filters( 'rehub_post_layout_array', array(
		...
		array(
			...
			'label' => esc_html__('Optimized for reading', 'rehub-framework'),
		),			
		array(
			'value' => 'meta_compact',
	...
	if (defined('\ContentEgg\PLUGIN_PATH')){
		$postlayoutce = array(
			array(
				...
				'label' => esc_html__('Price comparison (deprecated)', 'rehub-framework'),
			),			
			array(
			...
			array(
				...
				'label' => esc_html__('Auto content Content Egg (deprecated)', 'rehub-framework'),
			),				
		);
...
function rehub_get_product_layout_array($type)
{
	$productlayout = apply_filters( 'rehub_global_product_layout_array', array(
		...
		array(
			...
			'label' => esc_html__('Default without sidebar', 'rehub-framework'),
		),
		array(
