...
class rehub_outer_mediad extends WP_Widget {
    ...
    function __construct() {
		$widget_ops = array( 'classname' => 'outer_widget', 'description' => esc_html__('Outcontent side ads widget.', 'rehub-framework') );
...
function widget( $args, $instance ) {
	...
	?>
	<div class="mediad outer_mediad_<?php echo esc_attr($side);?>" style="margin-left: <?php echo (int)$position;?>px; top: <?php echo (int)$margin;?>px; width: <?php echo (int)$width;?>px; position: <?php echo esc_attr($fixed);?>; left: 50%"><?php echo ''.$text_code; ?></div>
