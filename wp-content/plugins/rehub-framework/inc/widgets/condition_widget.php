...
function widget( $args, $instance ) {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'postid' ); ?>"><?php esc_html_e('Type post ID if you want to have widget only there. You can set several ids with comma', 'rehub-framework'); ?></label>
