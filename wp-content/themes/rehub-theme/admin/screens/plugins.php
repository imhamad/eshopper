...
<div class="wrap about-wrap rehub-wrap">
	...
	<div class="rehub-demo-themes rehub-install-plugins">
		...
		<div class="feature-section theme-browser rendered">
			...
			<div class="theme">
				<div class="theme-screenshot">
					<img src="<?php echo get_template_directory_uri() . '/admin/screens/images/rhgrand.jpg';?>" alt="theme">
					<div class="plugin-info">Use only for customization of child themes</div>
				</div>
				<h3 class="theme-name">RH Grandchild plugin</h3>
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo get_template_directory_uri() . '/plugins/rh-grandchild-plugin.zip';?>" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/codecanyon-DjFsywOe-woocommerce-product-filter.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/slider-revolution.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/layered-popups.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				<div class="theme-screenshot">
					<img src="<?php echo get_template_directory_uri()?>/admin/screens/images/wpaipost.jpg" alt="theme">
			...
			<div class="theme">
				<div class="theme-screenshot">
					<img src="<?php echo get_template_directory_uri()?>/admin/screens/images/wpaice.jpg" alt="theme">
					<div class="plugin-info">This is extension<br>Get WPAI plugin here - <a href="https://wordpress.org/plugins/wp-all-import/" target="_blank">Wp ALL Import</a>										</div>
				</div>
